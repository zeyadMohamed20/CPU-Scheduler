...
public class GUI_ME {
    ...
    public static void SchedulerChange(){
        ...
        if (schedular == "FCFS") {
            turnTime_value.setText("5555");
        }else if(schedular == "SJF_Preemptive"){
            turnTime_value.setText("252");
        }
    }
    ...
    public static void create_And_Show() {
        ...
        String[] schedule_Options = { "--Select Schedular--", "FCFS", "SJF_Preemptive", "SJF_Non Preemptive", "Round_Robin", "Priority" };
